...
| 参数名称            | 类型            | 必填 | 参数描述                                                                                                                                                                                                                                                                                            |
| :-------------- | :------------ | :-- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| model           | String        | 是  | 模型名称  • Sora 2：sora@2:normal  • Sora 2 pro: sora@2:pro  • Veo 3.1: veo@31:normal  • Veo 3.1 fast: veo@31:fast  • seedance 1.0 pro: seedance@1:pro  • Seedance 1.0 pro fast: seedance@1:pro_fast  • Vidu q2 turbo: vidu@q2:turbo  • Vidu q2 pro: vidu@q2:pro  • wan 2.5 preview: wan@2.5:preview |
